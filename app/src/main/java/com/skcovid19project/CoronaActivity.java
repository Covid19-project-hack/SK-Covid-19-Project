...
import com.skcovid19project.Adapter.CoronaAdapter;
import com.skcovid19project.Adapter.FAQAdapter;
import com.skcovid19project.Models.Corona;
import com.skcovid19project.Models.FAQ;
import com.skcovid19project.Models.Persons;
        ...
        JsonObjectRequest request1 = new JsonObjectRequest(Request.Method.GET,url1, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONObject jsonObject = response.getJSONObject("Sikkim").getJSONObject("districtData");
